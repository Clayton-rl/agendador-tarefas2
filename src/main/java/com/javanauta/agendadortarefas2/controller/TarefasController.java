package com.javanauta.agendadortarefas2.controller;

import com.javanauta.agendadortarefas2.business.TarefasService;
...
public class TarefasController {
    ...
    @GetMapping("/eventos")
    public ResponseEntity<List<TarefasDTO>> buscaListaTarefasPorPedido(
